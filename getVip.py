...
class tencent_movie(object):
    ...
    def parse_html_tengxun(self, html):
        ...
        first_select = int(raw_input('1.电视剧\n2.电影\n'))
        if (first_select == 1):
            ...
            last_host = 'http://api.xfsub.com/index.php?url=' + new_link
        else:
            last_host = 'http://api.xfsub.com/index.php?url=' + host
        self.driver = webdriver.Chrome(executable_path=r'chromedriver.exe')
        self.driver.maximize_window()
        self.driver.get(last_host)

    def main(self):
        show=raw_input('请输入电视剧或电影名：')
        name = str(show)
